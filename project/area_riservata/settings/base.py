...
PROJECT_NAME = "mosic2-area-riservata" or PACKAGE_NAME
PROJECT_PACKAGE = "area_riservata" or PACKAGE_NAME
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': normpath(join(RESOURCES_PATH, 'logs', 'mosic2-area-riservata.log')),
